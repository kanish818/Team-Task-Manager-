...
-- CreateEnum
CREATE TYPE "ActivityEntity" AS ENUM ('PROJECT', 'TASK', 'COMMENT', 'MEMBER');

-- CreateEnum
CREATE TYPE "ActivityAction" AS ENUM ('CREATED', 'UPDATED', 'DELETED', 'ASSIGNED', 'STATUS_CHANGED', 'PRIORITY_CHANGED', 'COMMENT_ADDED', 'MEMBER_ADDED', 'MEMBER_REMOVED');
...
-- CreateIndex
CREATE INDEX "TaskComment_createdAt_id_idx" ON "TaskComment"("createdAt", "id");
